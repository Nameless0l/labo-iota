              ...
              <div className="p-6">
                ...
                <ul className="space-y-4">
                  <li className="flex items-center">
                    ...
                    <div>
                      <p className="font-medium text-gray-800">Dr. Anne Marie CHANA</p>
